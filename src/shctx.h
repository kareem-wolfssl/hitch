...
typedef void (shsess_new_f)(unsigned char *sess, unsigned len, long cdate);
 ...
 */ 
void shsess_set_new_cbk(shsess_new_f *cb);
...
void shctx_sess_add(const unsigned char *sess, unsigned len, long cdate);
